...
#define CUSTOM_MACHINE_NAME "ZGG-3D"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 100, 86.14 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define MANUAL_Z_HOME_POS 252.3 // Distance between the nozzle to printbed after homing

...
#define CUSTOM_MACHINE_NAME "Pakho FDM PT"
...
#define MANUAL_Z_HOME_POS Z_MAX_POS // Distance between the nozzle to printbed after homing
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,400,86.14}  // default steps per unit for Ultimaker
